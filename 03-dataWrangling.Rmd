...
<div class="alert alert-success" role="alert">
  <h4 class="alert-heading" style="text-align: center; color: DarkRed">**Logical operators**</h4>
...
:::: {.infobox}
<p style="text-align: center; color: DarkRed; font-size: large">**Keyboard shortcut for the pipe operator**</p>
...
<div class="alert alert-success" role="alert">
  <h4 class="alert-heading" style="text-align: center; color: DarkRed">**_dplyr_ verbs**</h4>
  <ul><ul type = 'square' style="color: Black">
