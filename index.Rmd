...
It is recommended to install **R**, **RStudio**, and the required R packages to work on the examples of this book. Please, read the software installation guidelines before reading the book (Appendix \@ref(appenA)).
